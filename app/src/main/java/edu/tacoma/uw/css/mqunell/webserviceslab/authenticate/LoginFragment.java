...
public class LoginFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final EditText emailText = v.findViewById(R.id.email);
        final EditText pwdText = v.findViewById(R.id.password);

        Button signInButton = v.findViewById(R.id.sign_in);
        signInButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(email) || !email.contains("@")) {
                    ...
                    Toast.makeText(v.getContext(), "Enter valid password (6+ chars)", Toast.LENGTH_SHORT).show();
